...
export default function SMC1R1(props) {
    ...
    const [ST1Chart_val, setST1Chart_val] = React.useState([]);
        ...
        datasetsC.forEach((datasetC) => {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (datasetC.elementId === "ST1") {
                        setST1Chart(reversedData);
                        setST1Chart_val(reversedData);
                    } 
                })
                .catch((err) => {
    ...
    const chartST1_val = {
        ...
        datasets: [
            {
                label: "ST1",
                data: ST1Chart.map((item) => item.value),
                fill: false,
                backgroundColor: "rgba(75,192,192,1)",
                borderColor: "rgba(75,192,192,1)",
                                    ...
                                    <div className="flex flex-col gap-3 w-full">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/2 p-3">
                                                ...
                                                <div className="font-medium text-gray-400 text-center justify-center items-center">
                                                    <Line data={chartST1_val} options={options} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
