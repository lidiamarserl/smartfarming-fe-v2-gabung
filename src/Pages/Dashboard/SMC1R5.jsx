...
export default function SMC1R1(props) {
    ...
    const [SM_C1R5Chart_val, setSM_C1R5Chart_val] = React.useState([]);
        ...
        datasetsC.forEach((datasetC) => {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (datasetC.elementId === "SM_C1R5") {
                        setSM_C1R5Chart(reversedData);
                        setSM_C1R5Chart_val(reversedData);
                    } 
                })
                .catch((err) => {
                                    ...
                                    <div className="flex flex-col gap-3 w-full">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/2 p-3">
                                                ...
                                                <div className="font-medium text-gray-400 text-center justify-center items-center">
                                                    <Line data={chartSM_C1R5_val} options={options} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
