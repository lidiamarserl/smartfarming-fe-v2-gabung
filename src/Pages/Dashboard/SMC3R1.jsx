...
export default function SMC1R1(props) {
    ...
    const [SM_C3R1Chart_val, setSM_C3R1Chart_val] = React.useState([]);
        ...
        datasetsC.forEach((datasetC) => {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (datasetC.elementId === "SM_C3R1") {
                        setSM_C3R1Chart(reversedData);
                        setSM_C3R1Chart_val(reversedData);
                    } 
                })
                .catch((err) => {
    ...
    const chartSM_C3R1_val = {
        labels: SM_C3R1Chart.map((item) => new Date(item.createdAt).toLocaleString()),
        datasets: [
            {
                label: "SM_C3R1",
                data: SM_C3R1Chart.map((item) => item.value),
                fill: false,
                backgroundColor: "rgba(75,192,192,1)",
                borderColor: "rgba(75,192,192,1)",
                                    ...
                                    <div className="flex flex-col gap-3 w-full">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/2 p-3">
                                                ...
                                                <div className="font-medium text-gray-400 text-center justify-center items-center">
                                                    <Line data={chartSM_C3R1_val} options={options} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
